...
uint8_t Serial_RxFlag;//接收数据标志位
char Serial_RxPacket[100];//收数据包
...
{
	static uint8_t RxState = 0;//静态标志变量，构建状态机
	static uint8_t pRxState = 0;//静态标志变量，定位接收数据位置
